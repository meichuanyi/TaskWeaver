...
### What is TaskWeaver?
TaskWeaver is a **code-first agent framework** designed for planning and executing **data analytics tasks**. Unlike text-based agent frameworks, TaskWeaver preserves both chat history and code execution history, including in-memory data.

### How does TaskWeaver differ from LangChain or AutoGen?
| Feature | TaskWeaver | LangChain | AutoGen |
|:---|:---|:---|:---|
| **Approach** | Code-first | Text-based | Conversation |
| **Memory** | Chat + Code execution + In-memory | Conversation only | Conversation + State |
| **Focus** | Data analytics | General tasks | Multi-agent collaboration |
| **Data Structures** | Rich (DataFrames, arrays) | Strings | Various |
| **Execution** | Container mode (secure) | Process | Sandbox |
...
```bash
docker run -it taskweaver/taskweaver
```

### What LLM providers does TaskWeaver support?
TaskWeaver supports:
...
See [LLM configuration](https://microsoft.github.io/TaskWeaver/docs/llms) for details.

### What is the Planner role?
The **Planner** decomposes complex tasks into sub-tasks, tracks progress, and coordinates between the User and CodeInterpreter.

### What is CodeInterpreter?
**CodeInterpreter** executes Python code generated by the Planner, handles data processing, and returns results.

### What are Plugins?
Plugins are **custom functions** you can create to extend TaskWeaver's capabilities. Each plugin is a Python function with a defined schema.

### What is the Recepta role?
[Recepta](https://microsoft.github.io/TaskWeaver/blog/reasoning) is an experimental role for enhanced reasoning power.

### How does TaskWeaver handle code execution security?
TaskWeaver uses **container mode** by default, providing a secure sandbox for code execution. You can also use process mode for simpler setups.

### What is shared memory?
[Shared memory](https://microsoft.github.io/TaskWeaver/docs/memory) stores information shared between roles (Planner, CodeInterpreter, etc.).

### How do I use local LLMs?
See [Local LLM guide](https://microsoft.github.io/TaskWeaver/blog/local_llm) for configuring Ollama or other local models.

### Where can I find examples?
- [Documentation](https://microsoft.github.io/TaskWeaver/)
- [Examples folder](https://github.com/microsoft/TaskWeaver/tree/main/examples)
- [Paper](http://export.arxiv.org/abs/2311.17541)
